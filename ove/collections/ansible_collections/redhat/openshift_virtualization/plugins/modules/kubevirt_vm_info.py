...
from ansible_collections.redhat.openshift_virtualization.plugins.module_utils.diff import (
    _patch_diff_objects,
)
...
from ansible_collections.redhat.openshift_virtualization.plugins.module_utils.info import (
    INFO_ARG_SPEC,
    execute_info_module,
)
