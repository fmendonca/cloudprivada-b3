...
- redhat.openshift_virtualization.kubevirt_auth_options
- inventory_cache
- constructed

options:
  plugin:
    description: Token that ensures this is a source file for the P(redhat.openshift_virtualization.kubevirt#inventory) plugin.
    required: True
    choices: ["kubevirt", "redhat.openshift_virtualization.kubevirt"]
  host_format:
    description:
...
class InventoryModule(BaseInventoryPlugin, Constructable, Cacheable):
    ...
    NAME = "redhat.openshift_virtualization.kubevirt"
    ...
    def _connections_compatibility(self, config_data: Dict) -> None:
        ...
        """
        collection_name = "redhat.openshift_virtualization"
