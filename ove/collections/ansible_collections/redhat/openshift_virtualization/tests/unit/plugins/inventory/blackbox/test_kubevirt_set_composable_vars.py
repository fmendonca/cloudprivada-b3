...
from ansible_collections.redhat.openshift_virtualization.plugins.inventory.kubevirt import (
    InventoryOptions,
)

from ansible_collections.redhat.openshift_virtualization.tests.unit.plugins.inventory.constants import (
    DEFAULT_NAMESPACE,
)
